...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                ...
                response_deserializer=location__pb2.EmptyMessage.FromString,
                )
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=location__pb2.EmptyMessage.SerializeToString,
            ),
    }
...
class LocationService(object):
    ...
    def Register(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LocationService/Register',
            location__pb2.LocationMessage.SerializeToString,
            location__pb2.EmptyMessage.FromString,
